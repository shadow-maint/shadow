...
def test_chage__last_changed_correct_date(shadow: Shadow, last_changed_date: str, expected_date: int | None):
    """
    :title: Set account last changed date correctly
    :setup:
        1. Create user
    :steps:
        1. Set correct account last changed date
...
def test_chage__last_changed_incorrect_date(shadow: Shadow, last_changed_date: str):
    """
    :title: Set account last changed date incorrectly
    :setup:
        1. Create user
    :steps:
        1. Set incorrect last changed date
        2. Check user exists and last changed date
    :expectedresults:
...
def test_chage__last_changed_empty_date(shadow: Shadow, last_changed: str):
    """
    :title: Empty account last changed
    :setup:
        1. Create user
    :steps:
