...
sgetspent(const char *s)
{
	...
	if (streq(fields[2], ""))
		spwd.sp_lstchg = -1;
	else if (a2i(long, &spwd.sp_lstchg, fields[2], NULL, 0, 0,) == -1)
		return NULL;
	...
	if (streq(fields[4], ""))
		spwd.sp_max = -1;
	else if (a2i(long, &spwd.sp_max, fields[4], NULL, 0, 0,) == -1)
		return NULL;
	...
	if (streq(fields[5], ""))
		spwd.sp_warn = -1;
	else if (a2i(long, &spwd.sp_warn, fields[5], NULL, 0, 0,) == -1)
		return NULL;
	...
	if (streq(fields[6], ""))
		spwd.sp_inact = -1;
	else if (a2i(long, &spwd.sp_inact, fields[6], NULL, 0, 0,) == -1)
		return NULL;
	...
	if (streq(fields[7], ""))
		spwd.sp_expire = -1;
	else if (a2i(long, &spwd.sp_expire, fields[7], NULL, 0, 0,) == -1)
		return NULL;
	...
	if (streq(fields[8], ""))
		spwd.sp_flag = SHADOW_SP_FLAG_UNSET;
	else if (a2i(unsigned long, &spwd.sp_flag, fields[8], NULL, 0,,) == -1)
		return NULL;
